...
|-------|-----|-----------|-------|---------|
| Обратная карточная сортировка | Качественный | 6+12 чел. | 15-20 мин | Success rate, Directness |
| Тестирование ожиданий | Качественный | 8 чел. | 20-30 мин | % совпадения |
...
| Usability-тестирование | Смешанный | 8 чел. | 40-50 мин | TSR, Time, Errors, Efficiency |
| SUS опрос | Количественный | 8 чел. | 5 мин | SUS Score (0-100) |

---

### 3.2. Участники исследования

**Общее количество:** 8 уникальных участников + 12 для TreeJack

**Демография:**

| Характеристика | Распределение |
|---------------|---------------|
| Возраст | 22-52 года (средний: 34.6 лет) |
| Пол | 50% мужчины, 50% женщины |
| Опыт онлайн-покупок | 12.5% низкий, 37.5% средний, 50% высокий |
| Технический уровень | 12.5% низкий, 37.5% средний, 50% высокий |

**Сегменты:**
- Частые покупатели (37.5%)
- Начинающие пользователи (12.5%)
- Придирчивые покупатели (25%)
- Tech-энтузиасты (25%)
...
- Android: Samsung Galaxy S21, S22 (Android 12-13)
- Сеть: Wi-Fi (50 Mbps)

**Общие условия:**
- Локация: Тихий офис, комфортная температура
- Время: Будни, 10:00-18:00
- Модератор: Наблюдение, метод "Think Aloud"
- Запись: Экран + аудио (с согласия участников)
