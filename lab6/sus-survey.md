...
**Количество респондентов:** 5 человек (студенты 18-22 лет)
...
#### P2 (Дмитрий, 21 год, средний опыт)
...
| P5 | Мобильное | Средний | 75 | B (Good) |
...
**Общий средний SUS (все 5 участников):**
- **SUS = (91.7 + 86.25) / 2 = 89.0**
- **Оценка: A (Excellent)**
- **Percentile Rank: ~ 87%**

**Это НАМНОГО ВЫШЕ среднего по индустрии (68)!**
